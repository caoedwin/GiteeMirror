...
from .models import DeviceABO, DeviceABOHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceABO)
class DeviceABOAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceABOHis)
class DeviceABOHisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
