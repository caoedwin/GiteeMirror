...
EMAIL_HOST_PASSWORD = 'xekeyfpljsikcafh' #你申请的授权码（略）
...
MEDIA_ROOT = 'I:\DMS_D disk\DMSmedia'
MEDIA_URL = 'I:/DMS_D disk/DMSmedia/'
# MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # 即项目路径下的media文件夹，没有则自动创建
MEDIAFILES_DIRS = (
    os.path.join(BASE_DIR, 'media'),

    r'I:/DMS_D disk/DMSmedia/',
...
CELERY_BEAT_SCHEDULE = {
    ...
    'task-one': {
        ...
        # 'schedule': 86400.0#60.0, # 每60秒执行一次
