...
class CapitalExpenditure(models.Model):
    ...
    Budget_Quantity = models.IntegerField("""預算數量""")
    ...
    Equivalent_To_RMB = models.IntegerField("""折合人民幣""")
    Payment_Terms = models.CharField("""付款條件""", max_length=200)
    Depreciation_Months = models.IntegerField("""折舊月數""")
    ...
    Annual_Increase_PerYear = models.IntegerField("""年增加收益""")
    Investment_Benefits_PerYear = models.IntegerField("""年投資效益""")
    Cash_Inflows_PerYear = models.IntegerField("""年淨現金流入""")
    Payback_Period = models.IntegerField("""回收年限(月數)""")
    Subscription_Status = models.CharField("""申購狀況""", max_length=20)
    Subscription_Quantity = models.IntegerField("""申購數量""")
