...
from .models import DeviceLNV, DeviceLNVHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceLNV)
class DeviceLNVAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
