...
class PICS(models.Model):
    ...
    pic = models.ImageField(upload_to='DeviceABO/PIC/',verbose_name='图片地址')
...
class DeclarationNofile(models.Model):
    # id = models.AutoField(max_length=10, primary_key=True, verbose_name='id')
    files = models.ImageField(upload_to='DeviceABO/DeclarationNo/',verbose_name='文件内容')
...
class DeviceABOHis(models.Model):
    Result_choice = (
        # ('Select Customer', 'Select Customer'),
        # ('', ''),
        ('Pass', 'Pass'),
