...
class PerExperienceAdmin(admin.ModelAdmin):
    list_display = ('Proposer_Num', 'Proposer_Name', 'Dalei', 'Department_Code', 'Project', "SS_Date", "Year", "Time_Interval", "Phase", "Role", "Function", "SubFunction_Com", "KeypartNum",
    ...
    # 筛选器
    list_filter = ("Proposer_Num", 'Department_Code', 'Project', 'Year', "Approved_Officer", "Status",)  # 过滤器
