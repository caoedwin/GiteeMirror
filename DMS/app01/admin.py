...
class UserInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ('account','password','CNname','username','Tel','Seat', 'email',)
    # 列表里显示想要显示的字段
    list_per_page = 200
    # 满50条数据就自动分页
    ordering = ('-account',)
    ...
    # 筛选器
    # list_filter = ('Customer','Project', 'Unit', 'Phase', 'Tester', 'Testitem','Result', 'Start_time', 'End_time', 'Result_time','Item_Des', 'Comments')  # 过滤器
    list_filter = ('account','password','CNname','username','email','Seat', )  # 过滤器
    search_fields = ('account','password','CNname','username','email','Seat', )  # 搜索字段
    # date_hierarchy = 'Start_time'  # 详细时间分层筛选
