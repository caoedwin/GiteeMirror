        ...
        if request.POST:
            ...
            try:
                ...
                if 'Returning' in str(request.body):
                    ...
                    checkAdaPow = {'Usrname': request.session.get('CNname'), 'BR_per_code': request.session.get('account'), 'BrwStatus': '已借出'}
            ...
            try:
                ...
                if 'ChangeStorages' in str(request.body):
                    ...
                    for i in responseData['params']:
                        ...
                        # updatedic['Last_Borrow_date'] = datetime.datetime.now().date(),
                        updatedic['Last_Return_date'] = datetime.datetime.now().date()
                        updatedic['uscyc'] = str(int(DeviceLNV.objects.filter(id=i).first().uscyc) + int(DeviceLNV.objects.filter(id=i).first().Last_uscyc))
                        updatedic['UsrTimes'] = str(int(DeviceLNV.objects.filter(id=i).first().UsrTimes) + 1)
        ...
        if 'Delete1' in str(request.body):
            ...
            for i in DeleteId:
                try:
                    ...
                    errormessae += """IntfCtgry:%s 有下层关联数据<br/>""" % DeviceIntfCtgryList.objects.filter(id=i).first().IntfCtgry
                    print(errormessae)
                    print(i)
        ...
        if 'Delete2' in str(request.body):
            ...
            for i in DeleteId:
                try:
                    ...
                    errormessae += """IntfCtgry:%s>DevCtgry:%s 有下层关联数据<br/>""" % (IntfCtgry, DeviceDevCtgryList.objects.filter(id=i).first().DevCtgry)
                    print(errormessae)
                    print(i)
        ...
        if 'Delete3' in str(request.body):
            ...
            for i in DeleteId:
                try:
                    ...
                    errormessae += """IntfCtgry:%s>DevCtgry:%s>Devproperties:%s 有下层关联数据<br/>""" % (IntfCtgry, DeviceDevpropertiesList.objects.filter(id=i).first().DevCtgry_P.DevCtgry, DeviceDevpropertiesList.objects.filter(id=i).first().Devproperties)
                    print(errormessae)
                    print(i)
        ...
        if 'Delete4' in str(request.body):
            ...
            for i in DeleteId:
                try:
                    ...
                    errormessae += """IntfCtgry:%s>DevCtgry:%s>Devproperties:%s >DevVendor:%s 有下层关联数据<br/>""" % (IntfCtgry, msgvalue.Devproperties_P.DevCtgry_P.DevCtgry, msgvalue.Devproperties_P.Devproperties, msgvalue.DevVendor)
                    print(errormessae)
                    print(i)
        ...
        if 'Delete5' in str(request.body):
            ...
            for i in DeleteId:
                try:
                    ...
                    errormessae += """IntfCtgry:%s>DevCtgry:%s>Devproperties:%s>DevVendor:%s>Devsize:%s 有下层关联数据<br/>""" % (IntfCtgry, msgvalue.DevVendor_P.Devproperties_P.DevCtgry_P.DevCtgry, msgvalue.DevVendor_P.Devproperties_P.Devproperties, msgvalue.DevVendor_P.DevVendor, msgvalue.Devsize)
                    print(errormessae)
                    print(i)
