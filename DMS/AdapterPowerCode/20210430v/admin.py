...
class AdapterPowerCodeBRAdmin(admin.ModelAdmin):
    fieldsets = (
        ...
        ('Advanced options',{
            'classes': ('collapse',),#折叠
            'fields' : ('Project_Code','Phase','OAP',"Device_Status"
    ...
    list_display = ('Changjia','MaterialPN','Description','Power','Number',"Location",'Customer','Project_Code','Phase','OAP',"Device_Status"
    ...
    ordering = ('-Number',)
    #后台数据列表排序方式
    list_display_links = ('Changjia','MaterialPN','Description','Power','Number',"Location",'Customer','Project_Code','Phase','OAP',"Device_Status"
