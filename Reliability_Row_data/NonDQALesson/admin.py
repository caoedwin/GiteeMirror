...
from .models import NonDQALesson, files_NonDQALesson
# Register your models here.
# admin.site.register(files_SpecD)
@admin.register(files_NonDQALesson)
class files_NonDQALessonAdmin(admin.ModelAdmin):
...
@admin.register(NonDQALesson)
class NonDQALessonAdmin(admin.ModelAdmin):
