            ...
            for i in PersonalInfo.objects.all():
                ...
                mock_data.append(
                    {"id": i.id, "Status": i.Status,
                     ...
                     "DepartureDate": str(i.QuitDate) if i.QuitDate else '',
                     "ExpectedDepartureDate": str(i.PlanQuitDate) if i.PlanQuitDate else '',
        ...
        if request.POST.get("isGetData") == "first":
            ...
            if reasonTable:
                for i in reasonTable:
                    ...
                    YUANYINBI.append(round(float(i["reasonDeparture"].split("%")[0]), 2))
