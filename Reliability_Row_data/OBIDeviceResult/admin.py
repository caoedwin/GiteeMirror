...
@admin.register(OBIDeviceResult)
class OBIDeviceResultAdmin(admin.ModelAdmin):
    list_display = ('Customer', 'Project', 'Platform', "Series", "Category", "DeviceNo", "PN",
                    "Devicename", "Testresult", "FWversion", "Softwareversion", "HWIDversion",
                    "TestPhase", "Comments")
    # 列表里显示想要显示的字段
    list_per_page = 500
    # 满50条数据就自动分页
    ...
    # 后台数据列表排序方式
    list_display_links = (
    'Customer', 'Project', 'Platform', "Series", "Category", "DeviceNo", "PN",
                    "Devicename", "Testresult", "FWversion", "Softwareversion", "HWIDversion",
                    "TestPhase", "Comments")
    # 设置哪些字段可以点击进入编辑界面
    ...
    list_filter = (
        ...
        'Project',
        'DeviceNo',)  # 过滤器
    search_fields = ('Customer', 'Project', 'DeviceNo',)  # 搜索字段
