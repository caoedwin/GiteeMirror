...
from .models import DeviceA39, DeviceA39His, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceA39)
class DeviceA39Admin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceA39His)
class DeviceA39HisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
